...
<div style="background-image:url(a2015-background-mainstage-gray.jpg);height:600px">

    <div style="float:left ; width:50%">
        <h1> <u> <font color = "white"> SILVER PACKAGE </font> </u> </h1>
        <img src="psilver2.jpg" width="400px">
        <br>
        <br>
        <p> <font color = "white"> Silver package includes :-
                <li> 10% discount - DJ or the music band we provide </li>
                <li> 10% discount - Photographers we provide </li>
                <li> 10% discount - Table and entrance decorations we provide </li>
                <br>
                <b> **APPROXIMATELY THE BUDGET - Rs. 150,000 - 200,000 </b> </font> </p>
    </div>
    <br><br><br><br><br>
    <div style="float:right ; width:50%">
        <form action="payments1.php">
            ...
            <br> <br>
            <font color = "white"> Offers Given to the Package(You can select one or more)
                <br>
                &nbsp &nbsp &nbsp &nbsp <input type="checkbox" name="DJ"> DJ <br>
                &nbsp &nbsp &nbsp &nbsp <input type="checkbox" name="DJ"> Music Band	<br>
                &nbsp &nbsp &nbsp &nbsp <input type="checkbox" name="DJ"> Table Decoration	<br>
                &nbsp &nbsp &nbsp &nbsp <input type="checkbox" name="DJ"> Entrance Decorations	<br>
                &nbsp &nbsp &nbsp &nbsp <input type="checkbox" name="Photographers"> Photographers	<br> </font>
